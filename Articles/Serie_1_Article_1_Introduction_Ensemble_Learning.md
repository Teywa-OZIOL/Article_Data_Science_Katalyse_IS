...
Si vous voulez en savoir plus sur la théorie concernant le boosting, [consultez cet article](https://github.com/Teywa-OZIOL/Article_Data_Science_Katalyse_IS/blob/main/Articles/Serie_1_Article_1_Introduction_Ensemble_Learning.md). Pour l'implémentation sous python d'un algorithme de boosting,  [cliquez ici](https://github.com/Teywa-OZIOL/Article_Data_Science_Katalyse_IS/blob/main/Articles/Serie_1_Article_1_Introduction_Ensemble_Learning.md).
</p>
